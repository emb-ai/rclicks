...
class SBDDataset(ISDataset):
    ...
    def get_sample(self, index):
        ...
        return DSample(image, instances_mask, objects_ids=instances_ids, sample_id=index, imname=image_path)
...
class SBDEvaluationDataset(ISDataset):
    def __init__(self, dataset_path, args, split='val', **kwargs):
        ...
        if args.n_samples:
            self.dataset_samples = self.get_sbd_images_and_ids_list()[:args.n_samples]
        else:
    ...
    def get_sample(self, index) -> DSample:
        ...
        return DSample(image, instances_mask, objects_ids=[1], sample_id=index, imname=image_path)
