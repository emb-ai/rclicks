...
import numpy as np
import cv2
from isegm.model.ops import DistMaps, DistMapsForSampling, ScaleLayer, BatchImageNormalize, DetrministicBilinear2D
...
class ISModel(nn.Module):
    def __init__(self, use_rgb_conv=False, with_aux_output=False,
